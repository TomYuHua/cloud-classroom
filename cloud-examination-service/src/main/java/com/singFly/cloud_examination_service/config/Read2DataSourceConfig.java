...
@Configuration
@MapperScan(basePackages = { "cloud.service.classroom.dao.cluster1" }, sqlSessionFactoryRef = "read2SqlSessionFactory")
public class Read2DataSourceConfig
{
	...
	public DataSourceTransactionManager read2TransactionManager(@Qualifier("read2DataSource") DataSource dataSource)
	{
