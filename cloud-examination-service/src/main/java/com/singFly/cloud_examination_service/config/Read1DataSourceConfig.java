...
@Configuration
@MapperScan(basePackages = { "cloud.service.classroom.dao.cluster" }, sqlSessionFactoryRef = "read1SqlSessionFactory")
public class Read1DataSourceConfig
{
	...
	public SqlSessionFactory read1SqlSessionFactory(@Qualifier("read1DataSource") DataSource dataSource)
			throws Exception
	{
