package com.singFly.cloud_examination_commonDfs.common;
...
/* Freeware from:
	...
	public class Base64_1
	{
		...
		/* constructor */
		public Base64_1(char chPlus, char chSplash, char chPad, int lineLength)
		{
			this.init(chPlus, chSplash, chPad);
			this.lineLength = lineLength;
		}

		public Base64_1(int lineLength)
		{
			this.lineLength = lineLength;
		}
